...
<script src="Responsive-2.2.3/js/dataTables.responsive.min.js"></script>
<script>
...
<script>
    $('#deleteCheckbox').click(function () {
        if ($('#deleteCheckbox').is(':checked')){
            sessionStorage.setItem('deleteStop', '1');

        }else{
            sessionStorage.setItem('deleteStop', '2');
        }
    });


    $(document).ready(function () {
        if (sessionStorage.getItem('deleteStop') == 1){
            $('.myModal').remove();
            $('.mySuppButton').removeAttr('data-toggle');
        }else{
            $('.reactiver').remove()
        }
    });

    $('.reactiver').click(function () {
        sessionStorage.clear();
        document.location.href= "/switch/admin/gestion_salle.php?action=affichage";
    });
</script>
